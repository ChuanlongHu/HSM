...
def process_single_query_with_timeout(
    ...
    try:
        ...
        if ppsm.maybe_contains_by_rect(q_tutte, total_tutte):
            ...
            rec["candidate_size"] = len(candidate_vertex_map)
            ...
            rec["filter_size"] = len(candidate_vertex_map) - len(f_candidate_vertex_map)
            # run verification/backtracking to find matches
            matchs,search_count = ppsm.validate_and_find_matches_baseline(query_graph, k, f_candidate_vertex_map, f_path_dict)
    ...
    for data_path in data_paths:
        ...
        for k in k_list:
            for qpath in query_paths:
                ...
                out_json = os.path.join(out_dir, f"{q_basename}_wo_search.json")
...
if __name__ == "__main__":
    ...
    DATA_FILES = ["./graphs/ba_Et20_Er34_n35.txt","./graphs/block_Et20_Er21_n10.txt","./graphs/er_Et20_Er21_n44.txt","./graphs/ws_Et20_Er70_n35.txt"]
    K_LIST = [1]                  # list of k values to test
