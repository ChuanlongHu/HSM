...
def process_single_query_with_timeout(
    ...
    try:
        ...
        if ppsm.maybe_contains_by_rect(q_tutte, total_tutte):
            ...
            candidate_vertex_map, candidate_edge_set, candidate_path_dict = ppsm_wo_cs.construct_candidate_solution_space_naive(query_graph, k, candidate_set, subgraph_map, bridges)
            ...
            matchs = ppsm.validate_and_find_matches(query_graph, k, f_candidate_vertex_map, f_path_dict)
    ...
    for data_path in data_paths:
        ...
        for k in k_list:
            for qpath in query_paths:
                ...
                out_json = os.path.join(out_dir, f"{q_basename}_k{k}_wo_cs.json")
...
if __name__ == "__main__":
    ...
    DATA_FILES = ["./graphs/ba_Et50_Er55_n56.txt","./graphs/block_Et50_Er54_n25.txt","./graphs/er_Et50_Er48_n70.txt","./graphs/ws_Et50_Er112_n56.txt"]
    K_LIST = [3]                  # list of k values to test
