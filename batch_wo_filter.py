...
def process_single_query_with_timeout(
    ...
    try:
        ...
        if ppsm.maybe_contains_by_rect(q_tutte, total_tutte):
            ...
            matchs = ppsm.validate_and_find_matches(query_graph, k, candidate_vertex_map, candidate_path_dict)
    ...
    for data_path in data_paths:
        ...
        for k in k_list:
            for qpath in query_paths:
                ...
                out_json = os.path.join(out_dir, f"{q_basename}_k{k}_wo_filter.json")
