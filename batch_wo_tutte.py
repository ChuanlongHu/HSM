...
def process_single_query_with_timeout(
    ...
    try:
        ...
        if 1==1:
            ...
            candidate_vertex_map, candidate_edge_set, candidate_path_dict = ppsm.construct_candidate_solution_space(query_graph, k, i_set, subgraph_map, bridges)
    ...
    for data_path in data_paths:
        ...
        for k in k_list:
            for qpath in query_paths:
                ...
                out_json = os.path.join(out_dir, f"{q_basename}_k{k}_wo_tutte.json")
